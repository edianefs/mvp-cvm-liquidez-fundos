...
-- P1 - fundos com maiores taxas acumuladas de resgate sobre PL médio do período.
SELECT
  CNPJ_FUNDO,
...
-- P2 - fundos com maior frequência de dias de fluxo líquido negativo.
SELECT
  CNPJ_FUNDO,
...
-- P3 - fundos com mais eventos acima do percentil 95 da amostra.
SELECT
  CNPJ_FUNDO,
